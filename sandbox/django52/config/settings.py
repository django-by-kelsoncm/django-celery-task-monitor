"""Settings do projeto sandbox rodando Django 5.2.

Usa o mesmo ``sandbox_app`` (pasta ``sandbox/sandbox_app``) que o projeto
irmão ``sandbox/django61``, para testar o plugin nas duas versões do Django
...
BASE_DIR = Path(__file__).resolve().parent.parent  # sandbox/django52/
SANDBOX_ROOT = BASE_DIR.parent  # sandbox/
sys.path.insert(0, str(SANDBOX_ROOT))

SECRET_KEY = "sandbox-django52-not-for-production"  # noqa: S105
DEBUG = True
ALLOWED_HOSTS = ["*"]
